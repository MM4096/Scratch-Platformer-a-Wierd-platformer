// Redirecting back to main page. Delete after finished
$(document).ready(function () {
    window.alert("This page is not yet ready!");
    window.close();
})
    ...
    for (let row = 0; row < currentLevel.length; row++) {
        ...
        for (let col = 0; col < currentLevel[0].length; col++) {
            ...
            if (currentLevel[row][col] === "1") {
                // Draw a rectangle at character position with a size of 32 x 32
